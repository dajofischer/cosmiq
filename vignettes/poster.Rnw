...
\SweaveOpts{prefix.string = graphics/cosmiq, eval = FALSE, eps = FALSE, pdf = TRUE}
...
\resizebox{.9\textwidth}{!}{\hspace{3.5cm} David Fischer$^\ddag$, Christian Panse$^\diamond$, and Endre Laczko$^\diamond$}\\[1.0cm]
}
